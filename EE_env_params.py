...
iran = ee.FeatureCollection("https://code.earthengine.google.com/?asset=users/tannerjohnson56/iran_admin").select("ADM2_EN") #users/tannerjohnson56/iran_admin").select("ADM2_EN") #Loads the iran boundaries asset with only county name field kept


yearlyParams=getYearlyParams(moWeather, iran, 2008, 2008)
